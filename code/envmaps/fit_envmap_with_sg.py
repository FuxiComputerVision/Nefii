...
#######################################################################################################
def SG2Envmap(lgtSGs, H, W, upper_hemi=False, coordinate_type="mitsuba"):
...
filename = '/root/Projects/PhySG/code/envmaps/sunrise.exr'
...
for step in range(N_iter):
    optimizer.zero_grad()
    env_map = SG2Envmap(lgtSGs, H, W, coordinate_type=coordinate_type)
